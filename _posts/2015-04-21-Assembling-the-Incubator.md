...
With everything in place, it was time to have some fun:
...
These were some of the Petri Dishes used in our first experiment, for testing purposes, in which random bacteria were collected from people's hands and personal objects:
...
In the absence of better life-wasting activities, you can watch the colonies grow (at least now they do it faster).
